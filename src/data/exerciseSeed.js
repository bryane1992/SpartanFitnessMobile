...
export function seedExercises() {
  return [
    ...
    //  BARBELL COMPOUNDS
    // ═══════════════════════════════════════════════════════════
    { id: 'bench_press', name: 'Bench Press', emoji: '', muscle_group: 'chest', secondary_muscles: ['triceps', 'shoulders'], category: 'barbell', style_tags: ['traditional', 'hybrid', 'crossfit'], exclusion_tags: ['heavy_barbell'], equipment_required: ['barbell', 'bench'], default_sets: 5, default_reps: '5', default_weight: '135 lb', is_compound: true, difficulty: 'intermediate' },
    { id: 'incline_bench', name: 'Incline Bench Press', emoji: '', muscle_group: 'chest', secondary_muscles: ['shoulders', 'triceps'], category: 'barbell', style_tags: ['traditional', 'hybrid'], exclusion_tags: ['heavy_barbell'], equipment_required: ['barbell', 'bench'], default_sets: 4, default_reps: '8', default_weight: '95 lb', is_compound: true, difficulty: 'intermediate' },
    { id: 'back_squat', name: 'Back Squat', emoji: '', muscle_group: 'legs', secondary_muscles: ['core', 'glutes'], category: 'barbell', style_tags: ['traditional', 'crossfit', 'hybrid'], exclusion_tags: ['heavy_barbell'], equipment_required: ['barbell', 'rack'], default_sets: 5, default_reps: '5', default_weight: '135 lb', is_compound: true, difficulty: 'intermediate' },
    { id: 'front_squat', name: 'Front Squat', emoji: '', muscle_group: 'legs', secondary_muscles: ['core', 'shoulders'], category: 'barbell', style_tags: ['traditional', 'crossfit', 'hybrid'], exclusion_tags: ['heavy_barbell'], equipment_required: ['barbell', 'rack'], default_sets: 4, default_reps: '6', default_weight: '95 lb', is_compound: true, difficulty: 'intermediate' },
    { id: 'deadlift', name: 'Deadlift', emoji: '', muscle_group: 'back', secondary_muscles: ['legs', 'core', 'glutes'], category: 'barbell', style_tags: ['traditional', 'crossfit', 'hybrid'], exclusion_tags: ['heavy_barbell'], equipment_required: ['barbell'], default_sets: 5, default_reps: '5', default_weight: '185 lb', is_compound: true, difficulty: 'intermediate' },
    { id: 'trap_bar_deadlift', name: 'Trap Bar Deadlift', emoji: '', muscle_group: 'back', secondary_muscles: ['legs', 'core'], category: 'barbell', style_tags: ['traditional', 'hybrid'], exclusion_tags: ['heavy_barbell'], equipment_required: ['barbell'], default_sets: 5, default_reps: '5', default_weight: '155 lb', is_compound: true, difficulty: 'intermediate' },
    { id: 'overhead_press', name: 'Overhead Press', emoji: '', muscle_group: 'shoulders', secondary_muscles: ['triceps', 'core'], category: 'barbell', style_tags: ['traditional', 'crossfit', 'hybrid'], exclusion_tags: ['heavy_barbell', 'overhead'], equipment_required: ['barbell'], default_sets: 4, default_reps: '6', default_weight: '75 lb', is_compound: true, difficulty: 'intermediate' },
    { id: 'barbell_row', name: 'Barbell Row', emoji: '', muscle_group: 'back', secondary_muscles: ['biceps', 'core'], category: 'barbell', style_tags: ['traditional', 'hybrid'], exclusion_tags: ['heavy_barbell'], equipment_required: ['barbell'], default_sets: 4, default_reps: '8', default_weight: '95 lb', is_compound: true, difficulty: 'intermediate' },
    { id: 'romanian_deadlift', name: 'Romanian Deadlift', emoji: '', muscle_group: 'legs', secondary_muscles: ['back', 'glutes'], category: 'barbell', style_tags: ['traditional', 'hybrid'], exclusion_tags: ['heavy_barbell'], equipment_required: ['barbell'], default_sets: 4, default_reps: '8', default_weight: '115 lb', is_compound: true, difficulty: 'intermediate' },
    { id: 'hip_thrust', name: 'Barbell Hip Thrust', emoji: '', muscle_group: 'glutes', secondary_muscles: ['legs'], category: 'barbell', style_tags: ['traditional', 'hybrid'], exclusion_tags: ['heavy_barbell'], equipment_required: ['barbell', 'bench'], default_sets: 4, default_reps: '10', default_weight: '135 lb', is_compound: true, difficulty: 'intermediate' },
    ...
    { id: 'ab_wheel', name: 'Ab Wheel Rollout', emoji: '', muscle_group: 'core', secondary_muscles: ['shoulders'], category: 'bodyweight', style_tags: ['traditional', 'hybrid', 'crossfit'], exclusion_tags: [], equipment_required: [], default_sets: 3, default_reps: '10', default_weight: 'BW', is_compound: false, difficulty: 'intermediate' },
    ...
    // ═══════════════════════════════════════════════════════════
    { id: 'wall_balls', name: 'Wall Balls', emoji: '', muscle_group: 'full_body', secondary_muscles: ['legs', 'shoulders'], category: 'bodyweight', style_tags: ['crossfit', 'hybrid'], exclusion_tags: [], equipment_required: [], default_sets: 3, default_reps: '15', default_weight: '14 lb ball', is_compound: true, difficulty: 'beginner' },
    ...
    { id: 'thrusters', name: 'Barbell Thrusters', emoji: '', muscle_group: 'full_body', secondary_muscles: ['legs', 'shoulders'], category: 'barbell', style_tags: ['crossfit', 'hybrid'], exclusion_tags: ['heavy_barbell', 'overhead'], equipment_required: ['barbell'], default_sets: 3, default_reps: '10', default_weight: '65 lb', is_compound: true, difficulty: 'intermediate' },
    ...
    { id: 'tire_flip', name: 'Tire Flips', emoji: '', muscle_group: 'full_body', secondary_muscles: ['legs', 'back', 'core'], category: 'bodyweight', style_tags: ['crossfit', 'hybrid'], exclusion_tags: [], equipment_required: ['outdoor'], default_sets: 3, default_reps: '5', default_weight: 'Medium tire', is_compound: true, difficulty: 'intermediate' },
    { id: 'sled_push', name: 'Sled Push', emoji: '', muscle_group: 'legs', secondary_muscles: ['core', 'shoulders'], category: 'bodyweight', style_tags: ['crossfit', 'hybrid'], exclusion_tags: [], equipment_required: [], default_sets: 3, default_reps: '40 yd', default_weight: '135 lb', is_compound: true, difficulty: 'intermediate' },
    { id: 'sled_pull', name: 'Sled Pull', emoji: '', muscle_group: 'back', secondary_muscles: ['biceps', 'legs'], category: 'bodyweight', style_tags: ['crossfit', 'hybrid'], exclusion_tags: [], equipment_required: [], default_sets: 3, default_reps: '40 yd', default_weight: '90 lb', is_compound: true, difficulty: 'intermediate' },
    { id: 'farmer_walk', name: 'Farmer Walk', emoji: '', muscle_group: 'full_body', secondary_muscles: ['core', 'grip'], category: 'dumbbell', style_tags: ['crossfit', 'hybrid', 'traditional'], exclusion_tags: [], equipment_required: ['dumbbell'], default_sets: 3, default_reps: '60 yd', default_weight: 'Heavy KBs', is_compound: true, difficulty: 'beginner' },
    { id: 'sandbag_carry', name: 'Sandbag Carry', emoji: '', muscle_group: 'full_body', secondary_muscles: ['core', 'legs'], category: 'bodyweight', style_tags: ['crossfit', 'hybrid'], exclusion_tags: [], equipment_required: ['outdoor'], default_sets: 3, default_reps: '100 yd', default_weight: '60 lb', is_compound: true, difficulty: 'intermediate' },
    ...
    { id: 'sumo_deadlift', name: 'Sumo Deadlift', emoji: '', muscle_group: 'legs', secondary_muscles: ['back', 'glutes'], category: 'barbell', style_tags: ['traditional', 'hybrid'], exclusion_tags: ['heavy_barbell'], equipment_required: ['barbell'], default_sets: 4, default_reps: '6', default_weight: '185 lb', is_compound: true, difficulty: 'intermediate' },

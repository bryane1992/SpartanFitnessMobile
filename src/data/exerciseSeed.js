...
export function seedExercises() {
  return [
    ...
    { id: 'ball_slams', name: 'Ball Slams', emoji: '', muscle_group: 'full_body', secondary_muscles: ['core', 'shoulders'], category: 'bodyweight', style_tags: ['crossfit', 'hybrid'], exclusion_tags: [], equipment_required: ['medicine_ball'], default_sets: 3, default_reps: '15', default_weight: '20 lb ball', is_compound: true, difficulty: 'beginner' },
    { id: 'battle_ropes', name: 'Battle Ropes', emoji: '', muscle_group: 'full_body', secondary_muscles: ['shoulders', 'core'], category: 'bodyweight', style_tags: ['crossfit', 'hybrid'], exclusion_tags: [], equipment_required: ['battle_ropes'], default_sets: 3, default_reps: '30s', default_weight: 'BW', is_compound: true, difficulty: 'beginner' },
    ...
    // ═══════════════════════════════════════════════════════════
    { id: 'rope_climb', name: 'Rope Climb', emoji: '', muscle_group: 'back', secondary_muscles: ['biceps', 'core'], category: 'bodyweight', style_tags: ['crossfit', 'hybrid'], exclusion_tags: [], equipment_required: ['rope'], default_sets: 3, default_reps: '1', default_weight: '15 ft rope', is_compound: true, difficulty: 'advanced' },

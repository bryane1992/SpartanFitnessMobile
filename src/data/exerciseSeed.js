...
export function seedExercises() {
  return [
    ...
    { id: 'trap_bar_deadlift', name: 'Trap Bar Deadlift', emoji: '', muscle_group: 'back', secondary_muscles: ['legs', 'core'], category: 'barbell', style_tags: ['traditional', 'hybrid'], exclusion_tags: [], equipment_required: ['barbell'], default_sets: 5, default_reps: '5', default_weight: '155 lb', is_compound: true, difficulty: 'intermediate' },
